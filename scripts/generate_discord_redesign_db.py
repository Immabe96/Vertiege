...
nav = [
    ("DCX-001", "Unify Home: worlds + DMs in one tab", "Merge Explore chat modes and server rail into Discord-style Home with overlapping panels", ["lib/screens/tabs/tab_layout.dart", "lib/screens/tabs/chat_list_screen.dart"], "Home tab servers + Messages"),
    ...
    ("DCX-003", "OverlappingPanelsLayout for world→channel", "Custom panel: server list | channel list | chat (Material easing, no drawer+tabs)", ["lib/ui/shell/v_overlapping_panels.dart"], "Android panels blog"),
    ("DCX-004", "Rename Identity tab to You", "Profile, status, friends, settings entry — Discord You tab pattern", ["lib/screens/tabs/identity_screen.dart", "lib/ui/navigation/v_bottom_nav.dart"], "You tab"),
    ...
    ("DCX-008", "World discovery via Home search", "Global + in-server search with inline filter chips", ["lib/screens/search_screen.dart"], "Search filters"),
    ...
    ("DCX-013", "Server (world) icon rail", "Fixed left rail of circular world icons with unread badges", ["lib/ui/navigation/v_server_rail.dart"], "Server list rail"),
    ...
    ("DCX-020", "Quick switcher between worlds", "Long-press server rail or search to jump worlds", ["lib/ui/navigation/v_server_rail.dart"], "Quick server switch"),
    ...
    ("DCX-023", "Remove FAB on Nexus; composer in feed header", "Discord-style inline compose, not floating +", ["lib/screens/tabs/tab_layout.dart"], "Inline compose"),
...
theme = [
    ...
    ("DCX-029", "8px card radius; pill buttons", "Discord-friendly radii across VCard/VButton", ["lib/theme/v_tokens.dart"], "8px radius"),
    ...
    ("DCX-036", "Saturation/contrast accessibility sliders", "Discord-style a11y theme controls in Settings", ["lib/screens/settings_screen.dart"], "A11y sliders"),
...
chat = [
    ...
    ("DCX-052", "Image grid in messages", "1/2/3+ image layouts like Discord media", ["lib/widgets/chat/chat_image.dart"], "Media grid"),
    ...
    ("DCX-064", "Member list sidebar sheet", "Avatars + roles; tap to DM", ["lib/widgets/chat/v_member_list_sheet.dart"], "Member list"),
...
# WAVE 4 — World / server UI (18)
world = [
    ("DCX-069", "Rewrite world_detail as server home", "Channels-first layout; tabs demoted to overflow", ["lib/screens/world_detail_screen.dart"], "Server layout"),
    ...
    ("DCX-071", "World header compact", "Icon + name + chevron; no hero banner on chat path", ["lib/widgets/worlds/world_profile_header.dart"], "Compact server header"),
    ("DCX-072", "Member count in channel header", "Online/total in subtitle", ["lib/screens/world_channel_screen.dart"], "Member count"),
    ("DCX-073", "World settings gear in rail context menu", "Long-press world icon for settings/mute/leave", ["lib/ui/navigation/v_server_rail.dart"], "Server menu"),
    ...
    ("DCX-075", "World unread state on rail", "Bold white dot vs number pill", ["lib/ui/navigation/v_server_rail.dart"], "Unread server"),
    ("DCX-076", "Demote marketplace/jobs to server menu", "Keep features; not primary tabs", ["lib/config/world_page_ia.dart"], "Feature discoverability"),
    ...
    ("DCX-078", "World icon 48dp circle", "Consistent server avatar in rail and headers", ["lib/widgets/worlds/world_icon.dart"], "Server icons"),
    ...
    ("DCX-080", "Create world CTA at rail bottom", "+ icon like Discord add server", ["lib/ui/navigation/v_server_rail.dart"], "Add server"),
    ("DCX-081", "World tooltips on long press", "Name + member count preview", ["lib/ui/navigation/v_server_rail.dart"], "Server tooltip"),
...
feed = [
    ...
    ("DCX-089", "Post composer sticky top", "Single-line expand like Discord status/post", ["lib/widgets/feed/post_input.dart"], "Composer"),
    ...
    ("DCX-093", "Achievement unlock toast Discord-style", "Bottom toast with badge art, not modal", ["lib/widgets/core/v_feedback.dart"], "Toast notifications"),
...
profile = [
    ...
    ("DCX-105", "Status: online/idle/dnd/custom", "Presence picker like Discord", ["lib/widgets/profile/status_picker.dart"], "Custom status"),
...
comp = [
    ...
    ("DCX-113", "VSearchBar with filter chips", "Search component for global/in-server", ["lib/ui/inputs/v_search_bar.dart"], "Search bar"),
    ...
    ("DCX-117", "VSheet → side panel variant", "Member list as side sheet on tablet", ["lib/ui/overlays/v_sheet.dart"], "Side panels"),
...
perf = [
    ...
    ("DCX-131", "44dp min touch targets on rail", "Server icons meet touch guidelines", ["lib/ui/navigation/v_server_rail.dart"], "Touch targets"),
...
# Vertiege differentiators (10) — better than Discord
plus = [
    ...
    ("DCX-137", "World treasury widget in server menu", "RPG economy glance without leaving chat", ["lib/screens/world_treasury_screen.dart"], "Treasury glance"),
    ...
    ("DCX-143", "Reputation/tier on member hover card", "Rich member card on tap in list", ["lib/widgets/chat/v_member_card.dart"], "Member card"),
...
doc = {
    ...
    "project": "Vertiege Commune UX (Discord++)",
    "created": "2026-06-05",
    "research_sources": [
    ...
    "waves": [
        ...
        {"id": 4, "name": "World / server UI", "changes": 18},
