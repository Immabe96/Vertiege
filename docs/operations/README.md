...
Tester-facing copy and engineering verification on real devices.

| Doc | Audience |
|-----|----------|
| [beta/tester-guide.md](beta/tester-guide.md) | Closed beta testers |
| [uat/issue-log.md](uat/issue-log.md) | Device UAT findings (living log) |
