      ...
      child: CustomScrollView(
        slivers: [
          if (todayList.isNotEmpty) ...[
            ...
            _NotificationSliverList(notifications: todayList, ref: ref, theme: theme),
          ],
          if (weekList.isNotEmpty) ...[
            _SectionHeader(title: _labelForGroup(_DateGroup.thisWeek)),
            _NotificationSliverList(notifications: weekList, ref: ref, theme: theme),
          ],
          if (earlierList.isNotEmpty) ...[
            _SectionHeader(title: _labelForGroup(_DateGroup.earlier)),
            _NotificationSliverList(notifications: earlierList, ref: ref, theme: theme),
          ],
...
class _NotificationSliverList extends StatelessWidget {
  ...
  static Color _colorForTypeStatic(NotificationType type) {
    return switch (type) {
      NotificationType.like => AppColors.dangerRed,
      NotificationType.comment => AppColors.eelBlue,
      NotificationType.worldUnlocked => AppColors.online,
      NotificationType.tierUpgrade => AppColors.streakOrange,
      NotificationType.welcome => AppColors.seed,
    };
  }
}
    ...
    return ClipRRect(
      ...
      child: Container(
        decoration: BoxDecoration(
          ...
          boxShadow: unread ? ShadowTokens.sm : null,
        ),
