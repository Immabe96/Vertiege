...
class _SettingsScreenState extends ConsumerState<SettingsScreen> {
  ...
  void _estimateCacheSize() {
    // Rough estimate: Flutter's image cache holds up to
    // imageCache.maximumSize (default 1000) images.
    // Average compressed image ~200KB on disk, ~2MB decoded.
        ...
        content: const SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              Text('Design & Development', style: TextStyle(fontWeight: FontWeight.w600)),
              SizedBox(height: Spacing.xs),
              Text('The Vertiege Team'),
              SizedBox(height: Spacing.md),
              Text('Special Thanks', style: TextStyle(fontWeight: FontWeight.w600)),
              SizedBox(height: Spacing.xs),
        ...
        children: [
          ...
          _sectionCard(
            children: [
              ...
              _sectionDivider(),
              ListTile(
                leading: Icon(Icons.delete_outline, size: IconSizes.md, color: colorScheme.error),
                title: Text('Delete Account', style: TextStyle(color: colorScheme.error)),
                subtitle: const Text('Permanently remove your account'),
                trailing: Icon(Icons.chevron_right, size: IconSizes.md, color: colorScheme.error),
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        const Icon(Icons.palette, size: IconSizes.md),
                        const SizedBox(width: Spacing.md),
                        Expanded(
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: const [
                              Text('Theme', style: TextStyle(fontSize: FontSizes.bodyLarge)),
                              Text(
          ...
          _sectionCard(
            children: [
              ListTile(
                leading: Icon(Icons.delete_forever, size: IconSizes.md, color: colorScheme.error),
    ...
    return AlertDialog(
      title: Row(
        children: [
          ...
          Text('Reset all data?', style: TextStyle(color: colorScheme.error)),
        ],
      ),
      content: _step == 0
          ? const Text(
