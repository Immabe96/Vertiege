            ...
            child: Container(
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  ...
                  colors: [
                    AppColors.darkSurfaceBase.withValues(alpha: 0.65),
                    AppColors.darkSurfaceBase.withValues(alpha: 0.8),
              ...
              Transform.scale(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    boxShadow: [
                      BoxShadow(
                        color: AppColors.seed.withValues(alpha: 0.5 * _iconScale.value),
                        blurRadius: 32,
                        spreadRadius: 4,
                      ),
                    ],
      ...
      child: const Stack(
        children: [
          ...
          Positioned(
            top: -120,
            right: -80,
            child: _DecoShape(size: 400, rotation: 0.4, color: AppColors.seed, opacity: 0.08),
          ),
          // Bottom-left medium shape
          Positioned(
            bottom: -100,
            left: -60,
            child: _DecoShape(size: 300, rotation: -0.6, color: AppColors.brandGreen, opacity: 0.07),
          ),
          // Top-left small shape
          Positioned(
            top: 80,
            left: -40,
            child: _DecoShape(size: 200, rotation: 0.8, color: AppColors.gemPink, opacity: 0.06),
          ),
          // Bottom-right small shape
          Positioned(
            bottom: 180,
            right: -50,
            child: _DecoShape(size: 180, rotation: -0.3, color: AppColors.streakOrange, opacity: 0.06),
          ),
        ],
      ),
    );
