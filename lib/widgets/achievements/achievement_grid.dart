...
class _AchievementGridState extends ConsumerState<AchievementGrid> {
  ...
  static const _categoryMeta = <AchievementCategory, ({
    ...
    AchievementCategory.relationships: (label: 'Relationships', icon: Icons.favorite),
    AchievementCategory.health: (label: 'Health', icon: Icons.fitness_center),
    ...
    AchievementCategory.community: (label: 'Community', icon: Icons.volunteer_activism),
    ...
    AchievementCategory.profession: (label: 'Profession', icon: Icons.verified_user),
  };
          ...
          SizedBox(
            ...
            child: ListView.separated(
              ...
              itemBuilder: (context, index) {
                ...
                return FilterChip(
                  avatar: Icon(meta.icon, size: IconSizes.sm),
