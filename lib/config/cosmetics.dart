...
const Map<String, CosmeticFrame> cosmeticFrames = {
  ...
  'bronze': CosmeticFrame(name: 'Bronze', color: Color(0xFFCD7F32), shadowRadius: 6, shadowOpacity: 0.4, elevation: 3),
  'silver': CosmeticFrame(name: 'Silver', color: Color(0xFFC0C0C0), shadowRadius: 8, shadowOpacity: 0.5, elevation: 4),
  'gold': CosmeticFrame(name: 'Gold', color: Color(0xFFD4A843), shadowRadius: 10, shadowOpacity: 0.6, elevation: 5),
  'diamond': CosmeticFrame(name: 'Diamond', color: Color(0xFFB9F2FF), shadowRadius: 12, shadowOpacity: 0.7, elevation: 6),
};
