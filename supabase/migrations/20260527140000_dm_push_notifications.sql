-- DM push: room_id on notifications + server-side notify (client cannot insert for other users).

ALTER TABLE public.notifications
  ADD COLUMN IF NOT EXISTS room_id TEXT REFERENCES public.dm_rooms(id) ON DELETE SET NULL;

CREATE INDEX IF NOT EXISTS idx_notifications_room_id
