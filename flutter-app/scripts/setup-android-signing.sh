...
echo "  $PROPS"
echo ""
echo "Back up the keystore and passwords (see docs/superpowers/specs/keystore-backup.md, repo root)."
echo "Passwords are stored only in flutter-app/android/key.properties on this machine."
