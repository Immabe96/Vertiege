...
Usage:
  ...
  python3 flutter-app/scripts/image_gen.py promote [--id ach-life] [--all]
  python3 flutter-app/scripts/image_gen.py list [--status pending]
"""
...
REPO_ROOT = ROOT.parent  # repo root — docs/ lives above flutter-app/
MANIFEST_PATH = REPO_ROOT / "docs/assets/image-manifest.json"
STAGING_DIR = ROOT / "assets/staging/generated"
FINAL_DIR = ROOT / "assets/generated"
LOG_PATH = REPO_ROOT / "docs/assets/generation-log.md"
...
def cmd_next(args: argparse.Namespace) -> None:
    ...
    payload = {
        ...
        "agentSteps": [
            ...
            f"python3 flutter-app/scripts/image_gen.py mark --id {item['id']} --status generated",
            "Review on dark UI; run process-transparent-assets.sh --staging if matte",
            f"python3 flutter-app/scripts/image_gen.py promote --id {item['id']}",
        ],
    }
    if args.json:
