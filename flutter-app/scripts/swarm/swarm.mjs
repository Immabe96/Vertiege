...
// SWARM_DIR is flutter-app/scripts/swarm — climb to the repo root, not to flutter-app/.
...
Usage:
  node flutter-app/scripts/swarm/swarm.mjs run --preset <research|dev|solo> "<mission>"
  node flutter-app/scripts/swarm/swarm.mjs audit              # codebase audit (research preset)
  node flutter-app/scripts/swarm/swarm.mjs audit-ui           # UI/UX + Forui + theming audit
...
Prioritize recent Linux port work: flutter-app/lib/main.dart, flutter-app/lib/app.dart,
flutter-app/lib/router/app_router.dart, flutter-app/lib/state/resident_provider.dart,
world channel routes, firebase_bootstrap, flutter-app/android/gradle.properties.
...
Focus: flutter-app/lib/app.dart, flutter-app/lib/theme/*, flutter-app/lib/forui/*,
flutter-app/lib/widgets/v_section_list.dart, flutter-app/lib/ui/*, flutter-app/lib/screens/tabs/*,
auth/onboarding, world_channel_screen, settings appearance.
