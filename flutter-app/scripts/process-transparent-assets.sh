...
#   ./flutter-app/scripts/process-transparent-assets.sh              # assets/generated/*.png (manifest)
#   ./flutter-app/scripts/process-transparent-assets.sh --staging  # assets/staging/generated/
#   ./flutter-app/scripts/process-transparent-assets.sh --dry-run
#   ./flutter-app/scripts/process-transparent-assets.sh --limit 3
#   ./flutter-app/scripts/process-transparent-assets.sh --category badge,profession
#
set -euo pipefail
...
MANIFEST="$REPO_ROOT/docs/assets/image-manifest.json"
